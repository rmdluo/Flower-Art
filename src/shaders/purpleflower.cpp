...
void addPoint1(float* vertices, int i) {
    ...
    vertices[5*i+2] = 230.0/255.0;
    vertices[5*i+3] = 230.0/255.0;
    vertices[5*i+4] = 250.0/255.0;
}
...
void addPoint2(float* vertices, int i) {
    ...
    vertices[5*i+2] = 147.0/255.0;
    vertices[5*i+3] = 112.0/255.0;
    vertices[5*i+4] = 219.0/255.0;
}
